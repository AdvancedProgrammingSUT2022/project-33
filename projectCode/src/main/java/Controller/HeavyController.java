...
import Model.HeavyRangedMilitaryUnits;
import Model.MatchingStrings;
import Model.UserInput;
import View.HeavyView;

public class HeavyController {
    HeavyRangedMilitaryUnits unit;
    HeavyView view;
    ...
    ////methods////
    public HeavyController(HeavyRangedMilitaryUnits unit)
    {
        this.unit = unit;
        view = new HeavyView(unit.getGameName());
