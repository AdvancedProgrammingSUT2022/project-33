...
public class MatchingStrings {
    ...
    {
        public final static Pattern USERNAME = Pattern.compile("[a-zA-Z0-9]+");
        public final static Pattern NICKNAME = Pattern.compile("(\\w)+");
        public final static Pattern PASSWORD = Pattern.compile("[a-zA-Z0-9]+");
    }
