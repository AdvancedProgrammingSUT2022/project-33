...
public enum MeleeUnits {
    WARRIOR(10, 2, 2, 40, 40, 1, 6, false, null, null, Eras.ANCIENT),
    SCOUT(8, 3, 2, 25, 25, 0, 4, false, null, null, Eras.ANCIENT),
    ...
    {
        unit = new MeleeMilitaryUnit(health, visibilityRange, maxMovements, price, productionRequiredForBeingMade, maintenancePricePerTurn,
